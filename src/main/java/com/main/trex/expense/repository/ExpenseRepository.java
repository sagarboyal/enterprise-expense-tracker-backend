...
""")
    ...
    @Query("""
        ...
        WHERE e.user.id = :userId
          ...
          AND a.status = com.main.trex.expense.entity.ApprovalStatus.APPROVED
    """)
    ...
    @Query("""
        ...
        WHERE e.user.id = :userId
          ...
          AND a.status = com.main.trex.expense.entity.ApprovalStatus.REJECTED
    """)
    ...
    @Query("""
        ...
        WHERE e.user.id = :userId
          ...
          AND a.status = com.main.trex.expense.entity.ApprovalStatus.PENDING
    """)
