...
""")
    ...
    @Query("""
        ...
        WHERE e.user.id = :userId
          ...
          AND a.status = com.main.trex.entity.ApprovalStatus.APPROVED
    """)
    ...
    @Query("""
        ...
        WHERE e.user.id = :userId
          ...
          AND a.status = com.main.trex.entity.ApprovalStatus.REJECTED
    """)
    ...
    @Query("""
        ...
        WHERE e.user.id = :userId
          ...
          AND a.status = com.main.trex.entity.ApprovalStatus.PENDING
    """)
